...
namespace SkeletonApi.Persistence.Repositories
{
    public class NotificationRepository : INotificationRepository
    {
        ...
        public async Task Create(Notifications mqttrawValues)
        {
            try
            {
                using (var uwow = _dapperUwow.Create())
                {
                    var connection = _getConnection.GetConnection();
                        ...
                        notification.CreatedAt = DateTime.UtcNow;
                        notification.Status = false;
                        notification.MachineName = mqttrawValues.MachineName;
                        notification.DateTime = mqttrawValues.DateTime;
                        notification.Message = mqttrawValues.Message;
