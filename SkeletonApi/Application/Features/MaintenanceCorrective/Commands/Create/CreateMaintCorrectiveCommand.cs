...
namespace SkeletonApi.Application.Features.MaintenanceCorrective.Commands.Create
{
    ...
    internal class CreateMaintCorrectiveCommandHandler : IRequestHandler<CreateMaintCorrectiveCommand, Result<CreateMaintCorrectiveDto>>
    {
        ...
        private readonly IMaintCorrectiveRepository _correctiveRepository;
        private readonly IMapper _mapper;

        public CreateMaintCorrectiveCommandHandler(IUnitOfWork unitOfWork, IMaintCorrectiveRepository maintCorrectiveRepository, IMapper mapper)
        {
            _unitOfWork = unitOfWork;
            _correctiveRepository = maintCorrectiveRepository;
            _mapper = mapper;
        }
