...
namespace SkeletonApi.Application.Features.DetailMachine.AssyWheelLine.Queries.ListQualityAssyWheelLine.WheelFrontWithPagination
{
    public record GetListQualityWheelFrontQuery : IRequest<PaginatedResult<GetListWheelFrontDto>>
    {
        ...
        public GetListQualityWheelFrontQuery(string types, string searchTerm, Guid machineId, int pageNumber, int pageSize)
        {
        ...
        internal class GetListQualityWheelFrontQueryHandler : IRequestHandler<GetListQualityWheelFrontQuery, PaginatedResult<GetListWheelFrontDto>>
        {
            ...
            public async Task<PaginatedResult<GetListWheelFrontDto>> Handle(GetListQualityWheelFrontQuery query, CancellationToken cancellationToken)
            {
                ...
                //TIRE INFLANTION QUALITY
                //DCM_P9AEA0_MC22_TIRE - PRESURE

                //PRES BEARING QUALITY
                //DCM_P9AEA0_MC22_BRNG - COUNT - OK
                //DCM_P9AEA0_MC22_BRNG - COUNT - NG
                //DCM_P9AEA0_MC22_BRNG - STATUS - PRDCT
                //DCM_P9AEA0_MC22_DISTANCE
                //DCM_P9AEA0_MC22_TONASE

                //FINAL INSPECTIONT QUALITY
                //DCM_P9AEA0_MC22_INPECT - COUNT - OK
                //DCM_P9AEA0_MC22_INPECT - COUNT - NG
                //DCM_P9AEA0_MC22_INPECT - STATUS - PRDCT
                //DCM_P9AEA0_MC22_DIAL - HOR
                //DCM_P9AEA0_MC22_DIAL - VER

                //DISK BRAKE QUALITY
                //DCM_P9AEA0_MC22_TORQ
            ...
            new { vid = torQ.Subject.Vid, dateNow = DateTime.Now.Date, });
                    ...
                    case "final_inspection":
                        ...
                        else
                        {
                            ...
                            foreach (var s in statusInspectionConsumption)
                            {
                                ...
                                {
                                    listQuality.DataTonase = Convert.ToDecimal(dataDialVertikal.Value);
                                }
                ...
                break;
                    case "disk_brake":
                        ...
                        else
                        {
                            foreach (var s in torQConsumption)
                            {
                                ...
                                var dataDial = torQConsumption.Where(k => k.Bucket == s.Bucket).FirstOrDefault();
                                if (dataDial != null)
                                {
                                    listQuality.DataDial = Convert.ToDecimal(dataDial.Value);
                                }                        
                                listQuality.DateTime = s.Bucket.AddHours(7);
                                dt.Add(listQuality);
                            }
                    ...
                    || query.search_term == c.DataDial.ToString()
