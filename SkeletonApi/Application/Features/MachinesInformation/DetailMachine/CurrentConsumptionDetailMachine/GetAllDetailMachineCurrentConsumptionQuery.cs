...
namespace SkeletonApi.Application.Features.MachinesInformation.DetailMachine.CurrentConsumptionDetailMachine
{
    //untuk semua machine yang mempunyai current consumption
    public record GetAllDetailMachineCurrentConsumptionQuery : IRequest<Result<GetAllDetailMachineCurrentAndVoltageConsumptionDto>>
    {
        ...
        public GetAllDetailMachineCurrentConsumptionQuery(Guid machineId, string type, DateTime startTime, DateTime endTime, string vid, string view)
        {
            MachineId = machineId;
            Type = type;
            Start = startTime;
        ...
        internal class GetAllDetailMachineCurrentConsumptionQueryHandler : IRequestHandler<GetAllDetailMachineCurrentConsumptionQuery, Result<GetAllDetailMachineCurrentAndVoltageConsumptionDto>>
        {
            ...
            public GetAllDetailMachineCurrentConsumptionQueryHandler(IDetailMachineRepository repository, IDayRepository dayRepository, IWeekRepository weekRepository, IMonthRepository monthRepository, IYearRepository yearRepository, IDefaultRepository defaultRepository)
            {
            ...
            public async Task<Result<GetAllDetailMachineCurrentAndVoltageConsumptionDto>> Handle(GetAllDetailMachineCurrentConsumptionQuery request, CancellationToken cancellationToken)
            {
