...
namespace SkeletonApi.Application.Features.DetailMachine.AssyWheelLine.Queries.ListQualityAssyWheelLine.WheelRearWithPagination
{
    public record GetListWheelRearQuery : IRequest<PaginatedResult<GetListWheelRearDto>>
    {
        ...
        internal class GetListWheelRearQueryHandler : IRequestHandler<GetListWheelRearQuery, PaginatedResult<GetListWheelRearDto>>
        {
            ...
            public GetListWheelRearQueryHandler(IDayRepository dayRepository, IDefaultRepository defaultRepository)
            {
            ...
            public async Task<PaginatedResult<GetListWheelRearDto>> Handle(GetListWheelRearQuery query, CancellationToken cancellationToken)
            {
                ...
                if (query.type == "day")
                {
                   if(query.type_wheel == "final_inspection")
                    {
                        var day = await _dayRepository.GetListQualityAssyWheelFinalInspection(query.type_wheel, query.search_term, query.machine_id, query.start, query.end);
                        data.AddRange(day);
                    }else if(query.type_wheel == "tire_inflation")
                    {
                        var day = await _dayRepository.GetListQualityAssyWheelTireInflation(query.type_wheel, query.search_term, query.machine_id, query.start, query.end);
                        data.AddRange(day);
                    }
                    else if(query.type_wheel == "disk_brake")
                    {
                        var day = await _dayRepository.GetListQualityAssyWheelDiskBrake(query.type_wheel, query.search_term, query.machine_id, query.start, query.end);
                        data.AddRange(day);
                    }
                    else
                    {
                        var day = await _dayRepository.GetListQualityAssyWheelPressBearing(query.type_wheel, query.search_term, query.machine_id, query.start, query.end);
                        data.AddRange(day);
                    }
                ...
                else
                {
                    ...
                    {
                        var defaultData = await _defaultRepository.GetListQualityAssyWheelPressBearing(query.type_wheel, query.search_term, query.machine_id, query.start, query.end);
                ...
                //   await _detailAssyWheelLineRepository.GetListWheelRearQuality(query.machine_id, query.type_wheel, query.type, query.start, query.end);
                ...
                ////final inspection
                //var statusInspection = machine.Where(m => m.Subject.Vid.Contains("FI-STATUS-PRODUKSI")).FirstOrDefault();
