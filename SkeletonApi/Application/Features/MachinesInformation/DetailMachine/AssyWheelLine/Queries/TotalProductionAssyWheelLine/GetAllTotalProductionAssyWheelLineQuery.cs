...
{
    public record GetAllTotalProductionAssyWheelLineQuery : IRequest<Result<GetAllTotalProductionAssyWheelLineDto>>
    {
        ...
        public GetAllTotalProductionAssyWheelLineQuery(Guid machineId, string type, DateTime start, DateTime end)
        {
            MachineId = machineId;
            Type = type;
            Start = start;
    ...
    internal class GetAllTotalProductionAssyWheelHandler : IRequestHandler<GetAllTotalProductionAssyWheelLineQuery, Result<GetAllTotalProductionAssyWheelLineDto>>
    {
        ...
        public async Task<Result<GetAllTotalProductionAssyWheelLineDto>> Handle(GetAllTotalProductionAssyWheelLineQuery query, CancellationToken cancellationToken)
        {
            ...
            var data = new GetAllTotalProductionAssyWheelLineDto();
            ...
            {
                data = new GetAllTotalProductionAssyWheelLineDto
                {
            ...
            else
            {
                ...
                data =
                new GetAllTotalProductionAssyWheelLineDto
                {
                    MachineName = machineName,
                    SubjectName = subjectName,
            ...
            return await Result<GetAllTotalProductionAssyWheelLineDto>.SuccessAsync(data, "Successfully fetch data");
        }
