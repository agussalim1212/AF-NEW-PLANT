...
namespace SkeletonApi.WebAPI.Migrations
{
    ...
    [Migration("20231121162323_part9.3")]
    partial class part93
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkeletonApi.Domain.Entities.Permissions", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("Permissions");
                });

            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("SkeletonApi.Domain.Entities.Role", null)
                        .WithMany()
